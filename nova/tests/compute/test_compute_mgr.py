...
class ComputeManagerUnitTestCase(test.NoDBTestCase):
    ...
    def test_init_instance_cleans_image_state_pending_upload_autoreboot(self):
        instance = instance_obj.Instance(self.context)
        instance.uuid = 'foo'
        instance.vm_state = vm_states.ACTIVE
        instance.task_state = task_states.IMAGE_PENDING_UPLOAD
        instance.metadata = {'reboot': 'True'}
        self._test_init_instance_cleans_image_states(instance)
    ...
    def test_init_instance_cleans_image_state_uploading_autoreboot(self):
        instance = instance_obj.Instance(self.context)
        instance.uuid = 'foo'
        instance.vm_state = vm_states.ACTIVE
        instance.task_state = task_states.IMAGE_UPLOADING
    ...
    def test_init_instance_cleans_image_state_snapshot_autoreboot(self):
        instance = instance_obj.Instance(self.context)
        instance.uuid = 'foo'
        instance.vm_state = vm_states.ACTIVE
        instance.task_state = task_states.IMAGE_SNAPSHOT
    ...
    def test_init_instance_cleans_image_state_snapsho_autoreboot(self):
        instance = instance_obj.Instance(self.context)
        instance.uuid = 'foo'
        instance.vm_state = vm_states.ACTIVE
        instance.task_state = task_states.IMAGE_SNAPSHOT_PENDING
    ...
    def test_init_instance_cleans_image_state_reboot_started_autoreboot(self):
        instance = instance_obj.Instance(self.context)
        instance.uuid = 'foo'
        instance.vm_state = vm_states.ACTIVE
        instance.task_state = task_states.REBOOT_STARTED

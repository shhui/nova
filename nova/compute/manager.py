...
class ComputeManager(manager.Manager):
    ...
    def _init_instance(self, context, instance):
        ...
        auto_reboot = None
        if instance.metadata and instance.metadata.get('reboot', None):
            auto_reboot = strutils.bool_from_string(
                     instance.metadata['reboot'])
            if auto_reboot and instance.power_state == power_state.SHUTDOWN:
                LOG.debug(_('auto restart instance'), instance=instance)
    ...
    def rename_virtualmachine(self, context, instance):
        self.driver.rename_virtualmachine(context, instance)
